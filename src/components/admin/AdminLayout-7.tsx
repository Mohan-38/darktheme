  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {/* Sidebar */}
        <aside 
          className={`fixed lg:sticky top-16 h-[calc(100vh-4rem)] w-64 bg-white shadow-md z-30 transform transition-transform duration-300 ease-in-out lg:translate-x-0 ${
