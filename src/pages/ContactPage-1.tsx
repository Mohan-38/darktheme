...
const ContactPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await sendEmail('template_k92zaj2', {
        from_name: name,
        from_email: email,
              ...
              <div className="col-span-2 p-8">
                ...
                {showSuccess ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <label htmlFor="project-type" className="block text-sm font-medium text-slate-700 mb-1">
                          Project Type
                        </label>
                        <select
                          id="project-type"
                      ...
                      <div>
                        <label htmlFor="budget-range" className="block text-sm font-medium text-slate-700 mb-1">
                          Budget Range
                        </label>
                        <select
                          id="budget-range"
                    ...
                    <div>
                      <label htmlFor="project-details" className="block text-sm font-medium text-slate-700 mb-1">
                        Project Details
                      </label>
                      <textarea
                        id="project-details"
